    ...
    <div className="my-5">
      ...
      <div className="flex items-center justify-start gap-x-4 mt-6">
        {isLoading ? (
          <Skeleton
            count={6}
            className="basis-modified6 h-[168px] w-1/6"
        ...
        {categories?.data.results.map((item: category) => (
          <Link
            ...
            key={item.id}
            className="flex flex-col items-center justify-center gap-y-4 shadow-ev2 hover:shadow-ev3 basis-modified6 py-8 rounded-custom transition-all"
          >
