...
interface IMobileDashboardOrdersTableProps {
  isLoading: boolean;
  orders?: order[];
}

function MobileDashboardOrdersTable({
  isLoading,
  orders,
}: IMobileDashboardOrdersTableProps) {
              ...
              <div className="flex-col p-3.5 text-sm" key={item.id}>
                ...
                <ul className="flex flex-col gap-y-4">
                  ...
                  <li className="flex items-center justify-between">
                    ...
                    <span className="font-light">{parsePaymentType(item)}</span>
                  </li>
                  <li className="flex items-center justify-between">
...
export { MobileDashboardOrdersTable };
